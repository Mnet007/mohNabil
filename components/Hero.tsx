...
const Hero = () => {
  return (
    <div className='pb-20 pt-26'>
        ...
        dark:bg-grid-white/[0.03] bg-grid-black/[0.2] flex items-center justify-center 
        ...
        <div className='flex justify-center relative my-20 z-10'>
            ...
            flex flex-col items-center justify-center'>
                ...
                <TextGenerateEffect 
                    ...
                    words='Turning Ideas into Reality with Perfect User Experiences'
                />

                <p className='text-center md:tracking-wider mb-4 
                text-sm md:text-lg lg:text-2xl'>
                    Hi, I&apos;m Mohammed Nabil, a Full-Stack Developer 
